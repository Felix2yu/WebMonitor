...
const HomePage = () => {
  ...
  const content = isChinese ? {
    ...
    features: [
      ...
      { icon: <ScheduleIcon sx={{ fontSize: 28 }} />, title: '灵活调度', description: '支持 Cron 表达式定时检查，适应不同网站与业务场景。', color: '#06b6d4' },
    ],
    ...
    features: [
      ...
      { icon: <ScheduleIcon sx={{ fontSize: 28 }} />, title: 'Flexible scheduling', description: 'Use Cron expressions to schedule checks for different websites and monitoring needs.', color: '#06b6d4' },
    ],
